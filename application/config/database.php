...
/*  Tarikh Cipta    : ?
 *  Programmer      : ?
 *  Tujuan Aturcara : Tetapan pangkalan data terhadap aplikasi CI
...
$db['default']['hostname'] = '10.22.120.115';
$db['default']['username'] = 'progbpm2008';
$db['default']['password'] = 'programmer';

/*$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'root';
$db['default']['password'] = '';
*/
$db['default']['database'] = 'db_exnewcomer';
