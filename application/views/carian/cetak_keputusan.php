...
<table align="center" class="table table-bordered" style="  border-bottom-width:  thick;  border-color:  #cc0000"   >
    ...
    <tr >
        ...
        <td><strong>: </strong></td>
        <td><strong>'.strtoupper($mykad).'</strong></td>
    </tr>
    <tr >
        <td><strong>Jawatan </strong></td>
        <td><strong>: </strong></td>
        <td><strong>'.strtoupper($perihalSkim).'</strong></td>
    </tr> 
    <tr >
        <td><strong>Gred </strong></td>
        <td><strong>: </strong></td>
        <td><strong> '.strtoupper($gred).'</strong></td>
    </tr>  
    <tr >
        <td><strong>Lokasi Bertugas  </strong></td>
        <td><strong>: </strong></td>
        <td><strong>'.strtoupper($perihalFasiliti).'</strong></td>
    </tr>   
    <tr >
    ...
    <tr >
        <td><strong>Tarikh Ujian </strong></td>
        <td><strong>: </strong></td>
        <td><strong> '.$tarikhUjian.'</strong></td>
    </tr>
</table>
<br/><br/><br/>
<table align="center" width="100%" border="0" cellspacing="5" cellpadding="5">
    ...
    <tr bgcolor="#E6E6E6" >
        ...
        <td align="center"><strong>'.$skor3.'</strong></td>
    </tr>
    <tr bgcolor="#E6E6E6" >
        <td align="center"><strong>KEBIMBANGAN</strong></td>
        <td align="center"><strong>'.$skor2.'</strong></td>
    </tr>
    <tr bgcolor="#E6E6E6" >
        <td align="center"><strong>KEMURUNGAN</strong></td>
        <td align="center"><strong>'.$skor1.'</strong></td>
    </tr>
</table>';      
?>