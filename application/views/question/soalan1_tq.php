...
<div class="container-fluid">	
    <div class="row-fluid">
        ...
        <div class="container-fluid" align="right">
            ...
            <a class="btn btn-primary" href="<?php echo site_url('/question/cetak/'.$mykad.'/'.$idPerkhidmatan.'/'.$idUjian)?>" > <i class="icon icon-print icon-white"></i> Cetak Keputusan</a>
            <!--a href="<?php echo site_url('question/cetak/'.$mykad.'/'.$idPerkhidmatan.'/'.$idUjian)?>" target="_blank">
